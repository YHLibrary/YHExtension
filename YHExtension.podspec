...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/YHLibrary/YHExtension"
  ...
  s.source       = { :git => "https://github.com/YHLibrary/YHExtension.git", :tag => s.version.to_s }
  ...
  s.source_files  = "YHExtension/YHExtension/**/*.{h,m}"
