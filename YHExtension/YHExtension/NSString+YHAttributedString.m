...
#import "NSString+YHAttributedString.h"

@implementation NSString (YHAttributedString)

- (NSAttributedString *)strikethroughWithFont:(UIFont *)font color:(UIColor *)color
{
    NSDictionary *dict = @{NSFontAttributeName:font,NSForegroundColorAttributeName:color,NSStrikethroughStyleAttributeName:@(NSUnderlineStyleSingle)};
    
    NSMutableAttributedString *attrString = [[NSMutableAttributedString alloc] initWithString:self attributes:dict];
...
{
    NSMutableAttributedString *stra = [[NSMutableAttributedString alloc]initWithString:self];
